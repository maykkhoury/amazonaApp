...
.controller('HomeCtrl', function($ionicPopup, $rootScope, $scope, $state, $ionicHistory,$timeout, myHttpService, MyLoginService,MySyncService) {
...
.controller('LoginCtrl', function($q,$rootScope, $scope, $timeout, $interval, $state, $ionicPopup, $ionicHistory,$ionicPlatform, MyLoginService,MySyncService) {
    ...
    // code to run each time view is entered
		if($rootScope.forceSync===1){
			//set the DB value
			MySyncService.setForceSync(1).then(function(){
				var myPopup = $ionicPopup.show({
					title: 'Sync',
					subTitle: 'New Data available!<br>please sync your app then logon again.',
					scope: $scope,
					buttons: [
					  {
						text: '<b>OK</b>',
	...
	$timeout(function() {
		//alert("LoginCtrl $ionicPlatform.ready");
